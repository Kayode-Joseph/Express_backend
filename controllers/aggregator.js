...
const login = async (req, res) => {
    ...
    if (is_password_the_same === true) {
        ...
        try {
            ...
            delete user_that_want_to_login.dataValues.aggregator_wallet
                .dataValues.pin;
...
const getAggregatorAgents = async (req, res) => {
    const { userId } = req.user;
    ...
    queryObject = {
        attributes: ['storm_id', 'email', 'business_name', 'aggregator_id'],
    ...
    let queryResult = email
        ? await user.findOne(queryObject)
