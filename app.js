    ...
    app.listen(process.env.PORT || 3000, async () => {
        try {
            ...
            cron.schedule('0 12 * * *', async () => {
                console.log(
                    'settling merchants from merchant transaction cache'
                );
                ...
                try {
                    const transaction_list =
                        await merchant_transaction_cache.findAll({
                            attributes: ['rrn'],
                            where: {
                                createdAt: {
                    ...
                    transaction_list.map(async (transaction) => {
                        ...
                        //     "UPDATE transactions SET settlement_status= 'compeleted' WHERE rrn=? ",
                        //     {
                        //         replacements: [transaction.rrn],
